...
Release `0.2.4` is published as `dev.yks:yks:0.2.4` in the repository's GitHub
...
```kotlin
dependencies {
    implementation("dev.yks:yks:0.2.4")
}
```
...
Pushing a tag such as `v0.2.4` runs the same gates, publishes that immutable
